...
def build_parser(config: dict | None = None) -> argparse.ArgumentParser:
    ...
    plan.add_argument("--judge", choices=["deterministic", "none", "openai_structured", "ensemble"], default=judge_config.get("name", "deterministic"))
    ...
    benchmark.add_argument("--judge", choices=["deterministic", "none", "openai_structured", "ensemble"], default=judge_config.get("name", "deterministic"))
    ...
    calibrate.add_argument("--judge", choices=["deterministic", "none", "openai_structured", "ensemble"], default=judge_config.get("name", "deterministic"))
