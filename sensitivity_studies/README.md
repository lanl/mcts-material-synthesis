...
to the other figure-generating code rather than here) - it still reuses this
directory's `common.py` harness and writes to the same
`results/starting_material_sweep/convergence_data.csv` below.
